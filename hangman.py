...
def main():
    ...
    while run:
        ...
        file = open('HangmanRecursosImportantes\\words.txt','r')
        l = file.readlines()
        ...
        for let in al:
            exec('{}=PhotoImage(file="HangmanRecursosImportantes\\\\{}.png")'.format(let, let))
            
        # hangman images
        h123 = ['h1','h2','h3','h4','h5','h6','h7']
        for hangman in h123:
            exec('{}=PhotoImage(file="HangmanRecursosImportantes\\\\{}.png")'.format(hangman,hangman))
